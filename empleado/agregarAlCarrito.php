...
// 1. Obtener los detalles base del producto
...
if (!$producto_base) {
    header("Location: ./vender.php?status=4"); // Producto no existe
    exit;
}
...
// Se prioriza el stock más alto y luego por el ID del almacén para consistencia en la asignación
