...
try {
    ...
    foreach ($_SESSION["carrito1"] as $producto) {
        ...
        foreach ($producto->fulfillment_sources as $source) {
            ...
            // echo "Intentando descontar: " . $cantidad_a_descontar . " unidades del producto " . $producto->id . " del almacén " . $almacen_nombre . " (ID: " . $almacen_id_origen . ")<br>";
            // *** FIN DEPURACIÓN ***
            ...
            if (!$resultadoActualizacion) {
                ...
                throw new Exception("Error al actualizar el stock para el producto " . $producto->id . " en el almacén " . $almacen_id_origen . ".");
            }
        }
    ...
    // Guardar los detalles de la venta en la sesión para mostrarlos en confirmacionVenta.php
